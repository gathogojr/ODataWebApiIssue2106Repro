...
namespace ReproNS
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ReproDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
        ...
        private static void Seed(IApplicationBuilder app)
        {
            ...
            {
                var db = serviceScope.ServiceProvider.GetRequiredService<ReproDbContext>();
                ...
                if (!db.Orders.Any())
                {
                    ...
                    try
                    {
                        ...
                        db.Database.ExecuteSqlRaw("SET IDENTITY_INSERT dbo.Customers ON");
                        db.SaveChanges();
                        db.Database.ExecuteSqlRaw("SET IDENTITY_INSERT dbo.Customers OFF");
                        ...
                        db.Database.ExecuteSqlRaw("SET IDENTITY_INSERT dbo.Orders ON");
                        db.SaveChanges();
                        db.Database.ExecuteSqlRaw("SET IDENTITY_INSERT dbo.Orders OFF");
                        ...
                        db.Database.ExecuteSqlRaw("SET IDENTITY_INSERT dbo.OrderItems ON");
                        db.SaveChanges();
                        db.Database.ExecuteSqlRaw("SET IDENTITY_INSERT dbo.OrderItems OFF");
                        ...
                        db.Database.ExecuteSqlRaw("SET IDENTITY_INSERT dbo.CustomerAddresses ON");
                        db.SaveChanges();
                        db.Database.ExecuteSqlRaw("SET IDENTITY_INSERT dbo.CustomerAddresses OFF");
